...
#################################################################Wells##########################################################################
awk '{print $1,$2}' GPSstationlist | gmt psxy -R -J -K -O -St0.3  -W0.01p,black -Gblue >> $PS
awk '{print $1,$2,$3}' GPSstationlist | gmt pstext -R -J -K -O -F+f8p,5,black+jBC -D0/0.2 >> $PS

awk '{print $1,$2}' GPSstationlist2 | gmt psxy -R -J -K -O -St0.3  -W0.01p,black -Gblue >> $PS
awk '{print $1,$2,$3}' GPSstationlist2 | gmt pstext -R -J -K -O -F+f8p,5,black+jTC -D0/-0.2 >> $PS

echo 117.88 39.56 | gmt psxy -R -J -K -O -St0.3  -Gblue -W0.01p,black >> $PS
echo 117.88 39.56 CH02 | gmt pstext -R -J -K -O -F+f8p,5,black+jBC -D-0.50/-0.05 >> $PS

echo 117.75 39.00  | gmt psxy -R -J -K -O -St0.3  -Gblue -W0.01p,black >> $PS
echo 117.75 39.00  KC01 | gmt pstext -R -J -K -O -F+f8p,5,black+jBC -D-0.20/0.2 >> $PS

echo 116.88 38.70  | gmt psxy -R -J -K -O -St0.3  -Gblue -W0.01p,black >> $PS
...
gmt pslegend -R -J -DjBR+w6.1c/2.8c+o0.1c/0.2c -F+gwhite@40+r -K -O >> $PS<< EOF
S 0.1i s 0.0000001 - 0.0p,- 0i
EOF

echo 117.97 38.6 | gmt psxy -R -J -K -O -St0.5 -W0.05p,black -Gblue >> $PS
echo "Continuous GPS Stations"|gmt pstext -R -K -J -F+f12p,1,black+cBR -Dj0.14i/0.96i -O -N>> $PS
