...
PS=GPS_vs_InSAR_ts_p2.ps

# min_GPS=$(awk 'NR == 1 || $2 < min {min = $2} END {print min-10}' $GPS_input)
# max_GPS=$(awk 'NR == 1 || $2 > max {max = $2} END {print max+5}' $GPS_input)
J=-JX2i/1.5i
R=-R2016/2023.8/-15.5/0

##############################################################################Station TJA1##############################################################################
gmt psbasemap $J $R -K -Bpxa2f1 -Bpya10f5 -BWs -P -X1.5i -Yc >$PS
gmt psbasemap -R -J -K -O -Ben -B0 >>$PS

awk '{print $1,$2}' $TJA1 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gdarkgray >>$PS
# gmt psxy -R -J -K -O tmp -W0.1p,gray,-  >>$PS

awk '{print $1,($2+15)/10}' $TJA140 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gblack >>$PS

awk '{print $1,($2)/10}' $TJA1400 >tmp
gmt psxy -R -J -K -O tmp -Sx0.05 -W0.03p,blue1 >>$PS

awk '{print $1,($2)/10}' $TJA11200 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gred >>$PS

awk '{print $1,($2-15)/10}' $TJA15000 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Ggreen >>$PS

echo  "TJA1"|gmt pstext -R -K -J -F+f5p,4,black+cTR -Dj0.1i/0.1i -Gwhite -O -N>> $PS

##################################################################################Station XUZZ##############################################################################
gmt psbasemap $J $R -K -Bpxa2f1 -Bpya10f5  -Bws -X2.2i -O >>$PS
gmt psbasemap -R -J -K -O -Ben -B0 >>$PS

awk '{print $1,$2}' $XUZZ >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gdarkgray >>$PS
# gmt psxy -R -J -K -O tmp -W0.1p,gray,-  >>$PS

awk '{print $1,($2+20)/10}' $XUZZ40 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gblack >>$PS

awk '{print $1,($2+15)/10}' $XUZZ400 >tmp
gmt psxy -R -J -K -O tmp -Sx0.05 -W0.03p,blue1 >>$PS

awk '{print $1,($2)/10}' $XUZZ1200 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gred >>$PS

awk '{print $1,($2+20)/10}' $XUZZ5000 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Ggreen >>$PS

echo  "XUZZ"|gmt pstext -R -K -J -F+f5p,4,black+cTR -Dj0.1i/0.1i -Gwhite -O -N>> $PS

##################################################################################Station TJCJ##############################################################################
gmt psbasemap $J $R -K -Bpxa2f1 -Bpya10f5+l'Vertical displacement (cm)'  -BWS -X-2.2i -Y-1.7i -O >>$PS
gmt psbasemap -R -J -K -O -Ben -B0 >>$PS

awk '{print $1,$2}' $TJCJ >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gdarkgray >>$PS
# gmt psxy -R -J -K -O tmp -W0.1p,gray,-  >>$PS

awk '{print $1,($2)/10}' $TJCJ40 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gblack >>$PS

awk '{print $1,($2+5)/10}' $TJCJ400 >tmp
gmt psxy -R -J -K -O tmp -Sx0.05 -W0.03p,blue1 >>$PS

awk '{print $1,($2-22)/10}' $TJCJ1200 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gred >>$PS

awk '{print $1,($2-22)/10}' $TJCJ5000 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Ggreen >>$PS

echo  "TJCJ"|gmt pstext -R -K -J -F+f5p,4,black+cTR -Dj0.1i/0.1i -Gwhite -O -N>> $PS

##################################################################################Station CH01##############################################################################
gmt psbasemap $J $R -K -Bpxa2f1 -Bpya10f5 -BwS -X2.2i -O >>$PS
gmt psbasemap -R -J -K -O -Ben -B0 >>$PS

awk '{print $1,$2}' $CH01 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gdarkgray >>$PS
# gmt psxy -R -J -K -O tmp -W0.1p,gray,-  >>$PS

awk '{print $1,($2-40)/10}' $CH0140 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gblack >>$PS

awk '{print $1,($2-40)/10}' $CH01400 >tmp
gmt psxy -R -J -K -O tmp -Sx0.05 -W0.03p,blue1 >>$PS

awk '{print $1,($2-40)/10}' $CH011200 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gred >>$PS

awk '{print $1,($2-40)/10}' $CH015000 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Ggreen >>$PS

echo  "CH01"|gmt pstext -R -K -J -F+f5p,4,black+cTR -Dj0.1i/0.1i -Gwhite -O -N>> $PS

##################################################################################Station GGSL##############################################################################
gmt psbasemap $J $R -K -Bpxa2f1 -Bpya10f5  -BWS -X-2.2i -Y-1.7i -O >>$PS
gmt psbasemap -R -J -K -O -Ben -B0 >>$PS

awk '{print $1,$2}' $GGSL >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gdarkgray >>$PS
# gmt psxy -R -J -K -O tmp -W0.1p,gray,-  >>$PS

awk '{print $1,($2)/10}' $GGSL40 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gblack >>$PS

awk '{print $1,($2)/10}' $GGSL400 >tmp
gmt psxy -R -J -K -O tmp -Sx0.05 -W0.03p,blue1 >>$PS

awk '{print $1,($2+5)/10}' $GGSL1200 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gred >>$PS

awk '{print $1,($2+25)/10}' $GGSL5000 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Ggreen >>$PS

echo  "GGSL"|gmt pstext -R -K -J -F+f5p,4,black+cTR -Dj0.1i/0.1i -Gwhite -O -N>> $PS

##################################################################################Station NIHE##############################################################################
gmt psbasemap $J $R -K -Bpxa2f1 -Bpya10f5 -BwS -X2.2i -O >>$PS
gmt psbasemap -R -J -K -O -Ben -B0 >>$PS

awk '{print $1,$2}' $NIHE >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gdarkgray >>$PS
# gmt psxy -R -J -K -O tmp -W0.1p,gray,-  >>$PS

awk '{print $1,($2-5)/10}' $NIHE40 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gblack >>$PS

awk '{print $1,($2+6)/10}' $NIHE400 >tmp
gmt psxy -R -J -K -O tmp -Sx0.05 -W0.03p,blue1 >>$PS

awk '{print $1,($2+6)/10}' $NIHE1200 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gred >>$PS

awk '{print $1,($2+6)/10}' $NIHE5000 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Ggreen >>$PS

echo  "NIHE"|gmt pstext -R -K -J -F+f5p,4,black+cTR -Dj0.1i/0.1i -Gwhite -O -N>> $PS
