...
##############################################################################Station JHAI##############################################################################
gmt psbasemap $J $R -K -Bpxa2f1 -Bpya10f5 -BWs -P -X1.5i -Yc >$PS
gmt psbasemap -R -J -K -O -Ben -B0 >>$PS

awk '{print $1,$2}' $JHAI >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gdarkgray >>$PS
# gmt psxy -R -J -K -O tmp -W0.1p,gray,-  >>$PS

awk '{print $1,($2-25)/10}' $JHAI40 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gblack >>$PS

awk '{print $1,($2-25)/10}' $JHAI400 >tmp
gmt psxy -R -J -K -O tmp -Sx0.05 -W0.03p,blue1 >>$PS

awk '{print $1,($2-25)/10}' $JHAI1200 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gred >>$PS

awk '{print $1,($2-60)/10}' $JHAI5000 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Ggreen >>$PS

echo  "JHAI"|gmt pstext -R -K -J -F+f5p,4,black+cTR -Dj0.1i/0.1i -Gwhite -O -N>> $PS

##################################################################################Station QING##############################################################################
gmt psbasemap $J $R -K -Bpxa2f1 -Bpya10f5 -BwS -X2.2i -O >>$PS
gmt psbasemap -R -J -K -O -Ben -B0 >>$PS

# awk '{print $1,$2/10}' /project/xhu/xiao/new_tianjin/plot/plot_compare_ts/nchina20/QING_GPS_mm.txt >tmp
# gmt psxy -R -J -K -O tmp -Sc0.03 -Ggray >>$PS
# gmt psxy -R -J -K -O tmp -W0.1p,gray,-  >>$PS
awk '{print $1,$2}' $QING >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gdarkgray >>$PS
# gmt psxy -R -J -K -O tmp -W0.1p,gray,-  >>$PS

awk '{print $1,($2-20)/10}' $QING40 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gblack >>$PS

awk '{print $1,($2-15)/10}' $QING400 >tmp
gmt psxy -R -J -K -O tmp -Sx0.05 -W0.03p,blue1 >>$PS

awk '{print $1,($2-15)/10}' $QING1200 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gred >>$PS

awk '{print $1,($2-45)/10}' $QING5000 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Ggreen >>$PS

echo  "QING"|gmt pstext -R -K -J -F+f5p,4,black+cTR -Dj0.1i/0.1i -Gwhite -O -N>> $PS

##################################################################################Station TJA2##############################################################################
gmt psbasemap $J $R -K -Bpxa2f1 -Bpya10f5+l'Vertical displacement (cm)'  -BWS -X-2.2i -Y-1.7i -O >>$PS
gmt psbasemap -R -J -K -O -Ben -B0 >>$PS

awk '{print $1,$2}' $TJA2 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gdarkgray >>$PS
# gmt psxy -R -J -K -O tmp -W0.1p,gray,-  >>$PS

# awk '{print $1,($2-22)/10}' $TJA240 >tmp
# gmt psxy -R -J -K -O tmp -Sc0.03 -Gblack >>$PS

# awk '{print $1,($2-11)/10}' $TJA2400 >tmp
# gmt psxy -R -J -K -O tmp -Sx0.05 -W0.03p,blue1 >>$PS

# awk '{print $1,($2)/10}' $TJA21200 >tmp
# gmt psxy -R -J -K -O tmp -Sc0.03 -Gred >>$PS

# awk '{print $1,($2-11)/10}' $TJA25000 >tmp
# gmt psxy -R -J -K -O tmp -Sc0.03 -Ggreen >>$PS

echo  "TJA2"|gmt pstext -R -K -J -F+f5p,4,black+cTR -Dj0.1i/0.1i -Gwhite -O -N>> $PS

##################################################################################Station TJBD##############################################################################
gmt psbasemap $J $R -K -Bpxa2f1 -Bpya10f5 -BwS -X2.2i -O >>$PS
gmt psbasemap -R -J -K -O -Ben -B0 >>$PS

awk '{print $1,$2}' $TJBD >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gdarkgray >>$PS
# gmt psxy -R -J -K -O tmp -W0.1p,gray,-  >>$PS

# awk '{print $1,($2-18)/10}' $TJBD40 >tmp
# gmt psxy -R -J -K -O tmp -Sc0.03 -Gblack >>$PS

# awk '{print $1,($2-18)/10}' $TJBD400 >tmp
# gmt psxy -R -J -K -O tmp -Sx0.05 -W0.03p,blue1 >>$PS

# awk '{print $1,($2-18)/10}' $TJBD1200 >tmp
# gmt psxy -R -J -K -O tmp -Sc0.03 -Gred >>$PS

# awk '{print $1,($2-30)/10}' $TJBD5000 >tmp
# gmt psxy -R -J -K -O tmp -Sc0.03 -Ggreen >>$PS

echo  "TJBD"|gmt pstext -R -K -J -F+f5p,4,black+cTR -Dj0.1i/0.1i -Gwhite -O -N>> $PS

##################################################################################Station WQCG##############################################################################
gmt psbasemap $J $R -K -Bpxa2f1 -Bpya10f5  -BWS -X-2.2i -Y-1.7i -O >>$PS
gmt psbasemap -R -J -K -O -Ben -B0 >>$PS

awk '{print $1,$2}' $WQCG >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gdarkgray >>$PS
# gmt psxy -R -J -K -O tmp -W0.1p,gray,-  >>$PS

# awk '{print $1,($2-10)/10}' $WQCG40 >tmp
# gmt psxy -R -J -K -O tmp -Sc0.03 -Gblack >>$PS

# awk '{print $1,($2-10)/10}' $WQCG400 >tmp
# gmt psxy -R -J -K -O tmp -Sx0.05 -W0.03p,blue1 >>$PS

# awk '{print $1,($2-10)/10}' $WQCG1200 >tmp
# gmt psxy -R -J -K -O tmp -Sc0.03 -Gred >>$PS

# awk '{print $1,($2+15)/10}' $WQCG5000 >tmp
# gmt psxy -R -J -K -O tmp -Sc0.03 -Ggreen >>$PS

echo  "WQCG"|gmt pstext -R -K -J -F+f5p,4,black+cTR -Dj0.1i/0.1i -Gwhite -O -N>> $PS

##################################################################################Station JIXN##############################################################################
gmt psbasemap $J $R -K -Bpxa2f1 -Bpya10f5 -BwS -X2.2i -O >>$PS
gmt psbasemap -R -J -K -O -Ben -B0 >>$PS

awk '{print $1,$2}' $JIXN >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gdarkgray >>$PS
# gmt psxy -R -J -K -O tmp -W0.1p,gray,-  >>$PS

# awk '{print $1,($2-30)/10}' $JIXN40 >tmp
# gmt psxy -R -J -K -O tmp -Sc0.03 -Gblack >>$PS
# #
# awk '{print $1,($2-35)/10}' $JIXN400 >tmp
# gmt psxy -R -J -K -O tmp -Sx0.05 -W0.03p,blue1 >>$PS

# awk '{print $1,($2-20)/10}' $JIXN1200 >tmp
# gmt psxy -R -J -K -O tmp -Sc0.03 -Gred >>$PS

# awk '{print $1,($2-45)/10}' $JIXN5000 >tmp
# gmt psxy -R -J -K -O tmp -Sc0.03 -Ggreen >>$PS

echo  "JIXN"|gmt pstext -R -K -J -F+f5p,4,black+cTR -Dj0.1i/0.1i -Gwhite -O -N>> $PS
...
gmt psconvert -A0.2c -E1000 -Tg $PS
# done
