...
awk '{print $1,$2}' $KC02 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gdarkgray >>$PS
# gmt psxy -R -J -K -O tmp -W0.1p,gray,-  >>$PS

awk '{print $1,($2-47)/10}' $KC0240 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gblack >>$PS

awk '{print $1,($2-35)/10}' $KC02400 >tmp
gmt psxy -R -J -K -O tmp -Sx0.05 -W0.03p,blue1 >>$PS

awk '{print $1,($2-45)/10}' $KC021200 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gred >>$PS

awk '{print $1,($2-70)/10}' $KC025000 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Ggreen >>$PS

echo  "KC02"|gmt pstext -R -K -J -F+f5p,4,black+cTR -Dj0.1i/0.1i -Gwhite -O -N>> $PS

##################################################################################Station TJWQ##############################################################################
gmt psbasemap $J $R -K -Bpxa2f1 -Bpya10f5  -Bws -X2.2i -O >>$PS
gmt psbasemap -R -J -K -O -Ben -B0 >>$PS

awk '{print $1,$2}' $TJWQ >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gdarkgray >>$PS
# gmt psxy -R -J -K -O tmp -W0.1p,gray,-  >>$PS

awk '{print $1,($2-10)/10}' $TJWQ40 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gblack >>$PS

awk '{print $1,($2-15)/10}' $TJWQ400 >tmp
gmt psxy -R -J -K -O tmp -Sx0.05 -W0.03p,blue1 >>$PS

awk '{print $1,($2-10)/10}' $TJWQ1200 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gred >>$PS

awk '{print $1,($2-40)/10}' $TJWQ5000 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Ggreen >>$PS

echo  "TJWQ"|gmt pstext -R -K -J -F+f5p,4,black+cTR -Dj0.1i/0.1i -Gwhite -O -N>> $PS

##################################################################################Station HECX##############################################################################
gmt psbasemap $J $R -K -Bpxa2f1 -Bpya10f5+l'Vertical displacement (cm)'  -BWS -X-2.2i -Y-1.7i -O >>$PS
gmt psbasemap -R -J -K -O -Ben -B0 >>$PS

awk '{print $1,$2}' $HECX >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gdarkgray >>$PS
# gmt psxy -R -J -K -O tmp -W0.1p,gray,-  >>$PS

awk '{print $1,($2-22)/10}' $HECX40 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gblack >>$PS

awk '{print $1,($2-11)/10}' $HECX400 >tmp
gmt psxy -R -J -K -O tmp -Sx0.05 -W0.03p,blue1 >>$PS

awk '{print $1,($2)/10}' $HECX1200 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gred >>$PS

awk '{print $1,($2-11)/10}' $HECX5000 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Ggreen >>$PS

echo  "HECX"|gmt pstext -R -K -J -F+f5p,4,black+cTR -Dj0.1i/0.1i -Gwhite -O -N>> $PS

##################################################################################Station TJJN##############################################################################
gmt psbasemap $J $R -K -Bpxa2f1 -Bpya10f5 -BwS -X2.2i -O >>$PS
gmt psbasemap -R -J -K -O -Ben -B0 >>$PS

awk '{print $1,$2}' $TJJN >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gdarkgray >>$PS
# gmt psxy -R -J -K -O tmp -W0.1p,gray,-  >>$PS

awk '{print $1,($2-18)/10}' $TJJN40 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gblack >>$PS

awk '{print $1,($2-18)/10}' $TJJN400 >tmp
gmt psxy -R -J -K -O tmp -Sx0.05 -W0.03p,blue1 >>$PS

awk '{print $1,($2-18)/10}' $TJJN1200 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gred >>$PS

awk '{print $1,($2-30)/10}' $TJJN5000 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Ggreen >>$PS

echo  "TJJN"|gmt pstext -R -K -J -F+f5p,4,black+cTR -Dj0.1i/0.1i -Gwhite -O -N>> $PS

##################################################################################Station HBGD##############################################################################
gmt psbasemap $J $R -K -Bpxa2f1 -Bpya10f5  -BWS -X-2.2i -Y-1.7i -O >>$PS
gmt psbasemap -R -J -K -O -Ben -B0 >>$PS

awk '{print $1,$2}' $HBGD >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gdarkgray >>$PS
# gmt psxy -R -J -K -O tmp -W0.1p,gray,-  >>$PS

awk '{print $1,($2-10)/10}' $HBGD40 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gblack >>$PS

awk '{print $1,($2-10)/10}' $HBGD400 >tmp
gmt psxy -R -J -K -O tmp -Sx0.05 -W0.03p,blue1 >>$PS

awk '{print $1,($2-10)/10}' $HBGD1200 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gred >>$PS

awk '{print $1,($2+15)/10}' $HBGD5000 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Ggreen >>$PS

echo  "HBGD"|gmt pstext -R -K -J -F+f5p,4,black+cTR -Dj0.1i/0.1i -Gwhite -O -N>> $PS

##################################################################################Station SW01##############################################################################
gmt psbasemap $J $R -K -Bpxa2f1 -Bpya10f5 -BwS -X2.2i -O >>$PS
gmt psbasemap -R -J -K -O -Ben -B0 >>$PS

awk '{print $1,$2}' $SW01 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gdarkgray >>$PS
# gmt psxy -R -J -K -O tmp -W0.1p,gray,-  >>$PS

awk '{print $1,($2-30)/10}' $SW0140 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gblack >>$PS
#
awk '{print $1,($2-35)/10}' $SW01400 >tmp
gmt psxy -R -J -K -O tmp -Sx0.05 -W0.03p,blue1 >>$PS

awk '{print $1,($2-20)/10}' $SW011200 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Gred >>$PS

awk '{print $1,($2-45)/10}' $SW015000 >tmp
gmt psxy -R -J -K -O tmp -Sc0.03 -Ggreen >>$PS

echo  "SW01"|gmt pstext -R -K -J -F+f5p,4,black+cTR -Dj0.1i/0.1i -Gwhite -O -N>> $PS
